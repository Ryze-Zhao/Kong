...
HtLogHandler.PRIORITY = 12
HtLogHandler.VERSION = "2.0.0"
...
function HtLogHandler.parse_url(host_url)
...
function HtLogHandler.send_payload(self, conf, payload)
  ...
  local ok, err
  local parsed_url = HtLogHandler.parse_url(http_endpoint)
...
function HtLogHandler.json_array_concat(entries)
  return "[" .. table_concat(entries, ",") .. "]"
end


function HtLogHandler.get_queue_id(conf)
